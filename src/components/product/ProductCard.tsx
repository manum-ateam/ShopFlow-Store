...
export default component$(({ product }: ProductCardProps) => {
  ...
  return (
    <div class="group h-full flex flex-col">
      <div class="relative aspect-square mb-6 rounded-md md:rounded-2xl overflow-hidden bg-surface-dim border border-border group-hover:border-primary/50 transition-all duration-500 hover:shadow-premium">
